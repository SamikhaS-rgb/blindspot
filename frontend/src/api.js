...
export const submitText = (texts, filters) =>
  api.post('/jobs/text', { texts, filters })

export const submitTopic = (topic, filters) =>
  api.post('/jobs/topic', { topic, filters })

export const submitPDFs = (files, filters) => {
